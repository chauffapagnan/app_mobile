...
class MQTTClientWrapper {
  ...
  void _setupMqttClient() {
    client = MqttServerClient.withPort('3f68ce49b7714ea2ac988e755d35fd99.s1.eu.hivemq.cloud', 'mqtt', 8883);
  ...
  void _publishMessage(String message) {
    ...
    debugPrint('Publishing message "$message" to topic ${'Dart/Mqtt_client/testtopic'}');
